...
/**
 * Live collaborative code editor UI for browsing repositories, opening and editing files, applying AI suggestions, and committing changes.
 *
 * Renders repository selector and tree, editor tabs with a Monaco editor, AI suggestion decorations, collaborator cursors, and a commit modal; manages fetching repos/tree/files, open file state, unsaved changes, save/commit workflow, and keyboard shortcuts.
 *
 * @returns A React element that renders the live editor interface.
 */
