...
/**
 * Determine whether a WebSocket request origin is permitted by configuration.
 *
 * @param {string|null|undefined} origin - The request Origin header value to check.
 * @returns {boolean} `true` if `origin` is present and either exactly matches an entry in `ALLOWED_ORIGINS` or `ALLOWED_ORIGINS` contains `"*"`, `false` otherwise.
 */
